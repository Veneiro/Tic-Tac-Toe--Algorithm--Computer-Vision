...
bool manoDetectadaEnTablero = false;

bool bossBattleActivo = false;

bool verificarResultadoPendiente = false;
bool verificarListo              = false;
bool verificarTableroLimpio      = false;
bool verificarManoEnTablero      = false;
